...
const AddMember = () => {
    ...
    return (
        <CenteredContainer style={{width: '800px'}}>            
            ...
            <h4 style={{textAlign: 'center'}}>An email will be sent, where they can accept your invitation</h4>
            <Divider />
            <Form
                {...formLayout}
                name='AddMember'
            ...
            >
                <Form.Item
                    ...
                    rules={[
                        {required: true, message: 'Requires an E-mail'}
                    ]}
                >
                    <Input />
                </Form.Item>
                ...
                >
                    <Radio.Group>
                        <Radio value='member'>Member: Basic permissions, can only submit work.</Radio>
                        <Radio value='manager'>Manager: Can add projects, manage projects, remove members.</Radio>
                        <Radio value='owner'>Owner: Can add projects, manage projects, remove members and managers.</Radio>
                    </Radio.Group>
                </Form.Item>
                <Divider />
